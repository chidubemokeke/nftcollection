...
export class Collection extends Entity {
  ...
  get collectionSymbol(): string | null {
  ...
  set collectionSymbol(value: string | null) {
    if (!value) {
      this.unset("collectionSymbol");
    } else {
      this.set("collectionSymbol", Value.fromString(<string>value));
    }
  }
